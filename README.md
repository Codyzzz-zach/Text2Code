...
- Python 3.11+
- An LLM API key (MiniMax, Anthropic, or OpenAI-compatible endpoint)
...
This runs an end-to-end demo with hardcoded entities on a short Chinese detective snippet.

### Full Extraction with LLM

```bash
# Extract Chapter 1 of Dream of the Red Chamber
...
├── examples/                   # Sample corpus & run scripts
│   ├── corpus/                 # Raw text samples
│   └── knowledge/              # Output directory (.t2c.py generated by scripts)
